...
void* AutoSplittingRuntime_new(void* shared_timer);
void AutoSplittingRuntime_drop(void* self);
bool AutoSplittingRuntime_load_script(void* self, char const* path);
bool AutoSplittingRuntime_unload_script(void* self);
...
void LayoutEditor_update_layout_state(void* self, void* state, void* timer);
char const* LayoutEditor_update_layout_state_as_json(void* self, void* state, void* timer);
...
void* SoftwareRenderer_new(void);
void SoftwareRenderer_drop(void* self);
void SoftwareRenderer_render(void* self, void* layout_state, void* data, uint32_t width, uint32_t height, uint32_t stride, bool force_redraw);
...
ssize_t Timer_current_split_index(void* self);
